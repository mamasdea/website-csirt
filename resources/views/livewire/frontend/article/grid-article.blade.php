{{-- resources/views/livewire/frontend/article/grid-articles.blade.php --}}
<div>
    {{-- Breadcrumb --}}
    <div class="bg-gray-400 bg-opacity-35 rounded-xl p-4 mb-2">
        <nav class="text-sm" aria-label="Breadcrumb">
            <ol class="list-none p-0 inline-flex items-center text-color">
                ...
                <li class="text-accent">Artikel</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 mb-6">
        <h1 class="text-2xl font-bold text-accent mb-2">Artikel</h1>
